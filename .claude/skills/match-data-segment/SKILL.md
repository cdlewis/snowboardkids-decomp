---
name: match-data-segment
description: Match a data segment by mapping it to an existing C file and replacing extern declarations with ordered definitions. Use when asked to match, add, split, or fix a .data segment in snowboardkids.yaml.
---

# Match a Data Segment
