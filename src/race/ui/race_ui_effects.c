...
u16 D_800D6520[] = {
    0x0001, 0x0000, 0x0006, 0x0001, 0x0000, 0x0007, 0x0001, 0x0001, 0x0008, 0x0001, 0x0000, 0x0009,
    0x0003, 0x0000, 0x000A, 0x0003, 0x0000, 0x000B, 0x0003, 0x0004, 0x000C, 0x0003, 0x0004, 0x000D,
    0x0003, 0x0004, 0x000E, 0x0003, 0x0004, 0x000F, 0x0003, 0x0004, 0x0010, 0x0003, 0x0004, 0x0011,
    0x0003, 0x0004, 0x0012, 0x0003, 0x0004, 0x0013, 0x0003, 0x0004, 0x0014, 0x0003, 0x0004, 0x0015,
    0x0003, 0x0004, 0x0016, 0x0003, 0x0004, 0x0017, 0x0003, 0x0004, 0x0018, 0x0003, 0x0004, 0x0019,
    0x0003, 0x0004, 0x001A, 0x0003, 0x0004, 0x001B, 0x0003, 0x0004, 0x001C, 0x0003, 0x0000, 0x001D,
    0x0003, 0x0000, 0x001E, 0x0003, 0x0008, 0x001F, 0x0003, 0x0008, 0x0020, 0x0003, 0x0008, 0x0021,
    0x0003, 0x0008, 0x0020, 0x0003, 0x0008, 0x0021, 0x0003, 0x0008, 0x0020, 0x0003, 0x0008, 0x0021,
    0x0003, 0x0000, 0x0022, 0x8003, 0x0001, 0x0023,
};
...
void func_80059C34(RaceUiCourseStatsActor *arg0) {
    ...
    for (row = 0, offset = 0; row != 5; row++, offset += 4, y += 0x20) {
        ...
        if ((row == actor->index) && (gUiBlinkTimer & 1)) {
            func_80059A04(&((RaceUiCourseStatsNameData *)&gGameSaveDataBuffer[0])->courseStatsNames[gRaceCourseIndex.signedValue][row],
                          0x10, y, 0x10);
        } else if (row < 3) {
            func_80059A04(&((RaceUiCourseStatsNameData *)&gGameSaveDataBuffer[0])->courseStatsNames[gRaceCourseIndex.signedValue][row],
                          0x10, y, 0xC);
