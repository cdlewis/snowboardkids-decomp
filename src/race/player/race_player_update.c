...
s32 tryStartRacePlayerCourseObjectMode(s16 arg0) {
    ...
    delta = gRacePlayers[arg0].posX - gRaceCourseStartEntries[gRaceCourseIndex].unk18;
    if (delta < 0) {
        delta = -delta;
    }
    if (delta > 0x180000) {
    ...
    delta = gRacePlayers[arg0].posZ - gRaceCourseStartEntries[gRaceCourseIndex].unk1C;
    if (delta < 0) {
        delta = -delta;
    }
    if (delta > 0x180000) {
