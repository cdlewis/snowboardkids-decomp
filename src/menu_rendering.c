...
void func_80013284(s16 x, s16 y, u16 glyph, u8 palette, u16 paletteScale, u16 paletteIndex, s32 fontBank) {
    ...
    if (palette == 0) {
        font = (MenuFontAssetTable *)getMemoryBlockBase(D_80112130[(u16)fontBank]);
        glyphWidth = 0x10;
    } else {
        font = (MenuFontAssetTable *)getMemoryBlockBase(D_80112132[(u16)fontBank]);
        glyphWidth = 8;
    }
...
void func_800137C8(s16 x, s16 y, u16 tileX, s32 tileY, u16 palette, u16 scale) {
    ...
    asset = (FontAsset *)getMemoryBlockBase(D_8011213C);
