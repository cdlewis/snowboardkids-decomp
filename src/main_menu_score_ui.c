...
extern s16 gControllerPakScoreSaveFlowTimer;
extern ControllerPakScoreSaveFlow gControllerPakScoreSaveFlow;
extern u16 gControllerPakScoreSaveFlowTargetState;
extern u16 gControllerPakScoreSaveFlowNextTimer;
extern u8 gControllerPakScoreSaveFlowStep;
...
void func_8002BDAC(MainMenuScoreTask *arg0) {
    ...
    if (state != (globalState = gControllerPakScoreSaveFlow.step)) {
        arg0->state.b.unk20 = globalState;
        state = globalState;
        arg0->unk1C.scale = gControllerPakScoreSaveFlow.timer;
        arg0->state.wu.slideOffset = gControllerPakScoreSaveFlow.targetState;
    }
    ...
    gControllerPakScoreSaveFlowStep = state;
...
void func_8002BF54(MainMenuScoreTask *arg0) {
    ...
    arg0->y = -0xE;
    arg0->unk1C.scale = 0x100;
    gControllerPakScoreSaveFlowTimer = 0x100;
...
void func_8002BF9C(MainMenuScoreTask *arg0) {
    ...
    if ((state >= 5) && (arg0->state.w.slideOffset == 0)) {
        gControllerPakScoreSaveFlowTargetState = arg0->state.w.selection;
...
void func_8002C18C(MainMenuScoreTask *arg0) {
    ...
    if (gControllerPakScoreSaveFlowNextTimer != arg0->state.w.selection) {
        arg0->state.w.selection = gControllerPakScoreSaveFlowNextTimer;
    }
