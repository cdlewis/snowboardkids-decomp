...
void func_8004002C(void) {
    ...
    loadCompressedRomAsset(D_60F1A0, D_60F990, 0x2A);
    gMainMenuSelectionResult = 0;
    createCallbackTask(initMainMenuCourseDemoOpeningDialog, 0, 0x64);
...
void func_800407AC(void) {
    ...
    if (temp_v1 == 0x80) {
        createCallbackTask(initMainMenuCourseDemoActionMenu, 0, 0x64);
...
void func_80040A48(void) {
    ...
    resetAllViewports();
    initCallbackTaskScheduler(0);
    createCallbackTask(&initMainMenuCourseDemoEndingDialog, 0, 0x64);
