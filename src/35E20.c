...
void func_800357E8(Struct35E20 *arg0) {
    s32 var_a1;
    ...
    if (var_a1 < (s32)0xFE700001) {
        arg0->unk18 = -0x1900000;
        func_80071824((s32)arg0, (void (*)(void))func_800357A4);
        D_8010B1A2 = 0x33;
        var_a1 = arg0->unk18;
    }
    func_8004209C(1, var_a1, arg0->unk1C, arg0->unk20);
...
void func_8003600C(Struct35E20 *arg0) {
    if (func_80041FB4(1) == 1) {
        arg0->unk2A += 1;
        if (arg0->unk2A < 3) {
        ...
        if (arg0->unk2A == 3) {
            arg0->unk2A = 0;
            D_8010B1A2 = 0xD;
            func_80071824((s32) arg0, (void (*)(void)) func_80035F80);
