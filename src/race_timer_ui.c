...
void func_80078568(s32 arg0) {
...

    {
        ...
        do {
            func_80046D68((s16)x, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
    ...
    func_80046D68(0x50, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x36, finalPalette);
    func_80046D68(0x68, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x35, finalPalette);
    ...
    if (D_80122043 < 10) {
        ...
        if (D_80122043 > 0) {
            do {
                func_80047174((s16)x, -0x68, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x26, 1);
                i++;
                x += 8;
            } while (i < D_80122043);
        }
    } else {
        func_80045A78(-0x84, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x26);
    }

    {
        ...
        do {
            if ((u8)*digit != ' ') {
                func_80045A78((s16)x, -0x58, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                              ((u8)*digit - 5) & 0xFFFF);
            }
            digit++;
            x += 8;
    ...
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x27);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x28);
    if (D_80121B81 != 0) {
        func_80045A78(0x40, 0x54, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x4F);
    }

    if (D_80122043 >= 10) {
        sprintf(buffer, D_800E172C, D_80122043);
        func_80045A78(-0x64, -0x59, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)buffer[0] - 5) & 0xFFFF);
        func_80045A78(-0x5C, -0x59, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)buffer[1] - 5) & 0xFFFF);
    }
}
#endif
...
void func_800789C0(s32 arg0) {
...

    {
        ...
        do {
            func_80046D68((s16)x, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)*digit - 5) & 0xFFFF,
                          palette & 0xFFFF);
            digit++;
            x += 8;
        } while ((u32)digit < (u32)end);
        ...
        func_80046D68(0x50, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x36, palette & 0xFFFF);
        func_80046D68(0x68, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x35, palette & 0xFFFF);
    }

    func_80045A78(0x68, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x20);

    {
        ...
        do {
            if ((u8)*digit != ' ') {
                func_80045A78((s16)(x + 0x60), -0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                              ((u8)*digit - 5) & 0xFFFF);
            }
            digit++;
            x += 8;
    ...
    if (D_80122290 > 0) {
        do {
            func_80045A78((s16)(x - 0x88), -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x21);
            i++;
            x += 8;
        } while (i < D_80122290);
    }

    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x22);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x23);
    if (D_80121B81 != 0) {
        func_80045A78(0x40, 0x54, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x4F);
    }
}
...
void func_80078D9C(s32 arg0) {
    ...
    digit = buffer;
    do {
        func_80045A78((s16)x, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)*digit - 5) & 0xFFFF);
        digit++;
        x += 8;
    } while ((u32)digit < (u32)end);
    ...
    func_80045A78(0x58, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x36);
    func_80045A78(0x70, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x35);

    if (D_80121B81 != 0) {
        func_80045A78(0x48, 0x54, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x4F);
    }

    func_80045A78(-0x88, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_800DC8F9);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x24);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x25);

    sprintf(buffer, D_800E1788, D_801222F0);
    func_80045A78(-0x60, -0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)buffer[0] - 5) & 0xFFFF);
    if (buffer[1] != 0) {
        func_80045A78(-0x58, -0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((u8)buffer[1] - 5) & 0xFFFF);
    }
}
#endif
...
void func_80079154(s32 arg0) {
    ...
    if (D_80121D80[0].onesDigitTile != 0) {
        func_80045A78(-0x10, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_800DC8F8[D_80121D80[0].onesDigitTile]);
    }

    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x24);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x2A);
}
...
void func_80079438(s32 arg0) {
    ...
    do {
        if (*digit != ' ') {
            func_80046D68((s16)x, 0x50, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), (*digit - 5) & 0xFFFF,
                          palette & 0xFFFF);
        }
        digit++;
        x += 8;
    ...
    func_80045A78(0x78, 0x50, getRelocatableHeapBlockBase(D_80112130.mainFontHandle), ((D_80121B72 >> 1) + 4) & 0xFFFF);

    if (player->tensDigitPalette != 0) {
        func_80047174(-0x20, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                      (player->tensDigitOffset + D_800DC8F0[player->tensDigitTile] - 1) & 0xFFFF,
                      player->tensDigitPalette);
    } else {
        func_80045A78(-0x20, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                      (player->tensDigitOffset + D_800DC8F0[player->tensDigitTile] - 1) & 0xFFFF);
    }

    if (player->onesDigitPalette != 0) {
        func_80047174(0, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_800DC8F8[player->onesDigitTile],
                      player->onesDigitPalette);
    } else {
        func_80045A78(0, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_800DC8F8[player->onesDigitTile]);
    }

    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), player->iconTile & 0xFFFF);
    func_80045A78(-0x88, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x39);
    func_80046D68(-0x68, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), (player->lapDigit + 0x2C) & 0xFFFF, 0xE);
    func_80045A78(-0x5C, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x38);
    func_80046D68(-0x50, -0x60, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), (gRaceLapCount + 0x2B) & 0xFFFF, 0xE);
}
#endif
...
void func_80079758(s32 arg0) {
    ...
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x24);
    func_80045A78(-0x88, 0x40, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x29);
}
#endif
...
void func_800799DC(s32 arg0) {
    ...
    do {
        if (*ptr != ' ') {
            func_80046D68(x, y, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), ((*ptr) - 5) & 0xFFFF, color & 0xFFFF);
        }
        ptr++;
        x += 8;
    } while (ptr != end);

    func_80045A78(0x78, y, getRelocatableHeapBlockBase(D_80112130.mainFontHandle), ((D_80121B72 >> 1) + 4) & 0xFFFF);

    if (D_80122293[gCurrentViewportIndex].value != 0) {
        player = &D_80121D80[gCurrentViewportIndex];
        func_80047174(-0x88, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                      (player->tensDigitOffset + D_800DC8F0[player->tensDigitTile] - 1) & 0xFFFF,
                      player->tensDigitPalette);
    } else {
        player = &D_80121D80[gCurrentViewportIndex];
        func_80045A78(-0x88, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                      (player->tensDigitOffset + D_800DC8F0[player->tensDigitTile] - 1) & 0xFFFF);
    }

    if (D_80122296[gCurrentViewportIndex].value != 0) {
        player = &D_80121D80[gCurrentViewportIndex];
        func_80047174(-0x68, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_800DC8F8[player->onesDigitTile],
                      player->onesDigitPalette);
    } else {
        func_80045A78(-0x68, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
                      D_800DC8F8[D_80122295[gCurrentViewportIndex].value]);
    }

    func_80045A78(-0x88, 0x12, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), D_80122289[gCurrentViewportIndex].value & 0xFFFF);

    finalY = 0x2A;
    if (gCurrentViewportIndex == 0) {
        finalY = -0x30;
    }
    func_80045A78(0x58, finalY, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x1A);
}
#endif
...
void func_80079E48(s32 arg0) {
    ...
    func_80047E88(0x80, *(s16 *)((u8 *)&sp1C + 2), (gRaceLapCount + 0x30) & new_var, 2);
}
...
void func_80079F04(s32 arg0) {
    ...
    func_80047174(0x38, 0x24, getRelocatableHeapBlockBase(D_80112130.mainFontHandle), ((D_80121B72 >> 1) + 4) & 0xFFFF, 1);

    texture = getRelocatableHeapBlockBase(D_80112130.popupFontHandle);
    player = &D_80121D80[gCurrentViewportIndex];
    ...
    if (gCurrentViewportIndex < 2) {
        func_80045A78(-0x44, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x1A);
        return;
    }
    func_80045A78(0x14, -0x30, getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x1A);
}
...
void func_8007A108(s32 arg0) {
    ...
    func_80047E88((s16)(x + 0x10), -0x30, (gRaceLapCount + 0x30) & 0xFF, 2);
}
...
sort_next:
    ...
    func_80045A78((s16)(xBase + 4), (s16)(yBase + 4), getRelocatableHeapBlockBase(D_80112130.popupFontHandle), 0x50);
        ...
        if (player->flashFrame != 0) {
            if (player->unk2D8 != 0) {
                ...
                func_80046D68(x, (s16)(player->raceProgress + yBase),
                              getRelocatableHeapBlockBase(D_80112130.popupFontHandle),
