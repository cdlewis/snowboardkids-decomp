...
const char gRaceMotionAnimationDebugViewerAnimationNumberFormat[] = "MOTION NO %3.3i";
...
void drawRaceMotionAnimationDebugViewerAnimationNumber(s32 arg0) {
    char buf[0x64];

    sprintf(buf, gRaceMotionAnimationDebugViewerAnimationNumberFormat,
...
void updateRaceMotionAnimationDebugViewer(void) {
    ...
    addRenderCallback(&gMenuForegroundRenderCallbackList, drawRaceMotionAnimationDebugViewerAnimationNumber, NULL);
}
