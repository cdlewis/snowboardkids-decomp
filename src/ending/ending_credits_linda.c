...
void waitEndingLindaPhase3A(EndingCreditsLinda *arg0) {
    ...
    if (gEndingCreditsSequencePhase == 0x3A) {
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)updateEndingLindaExitUntilPhase3C);
    }
}
...
void waitEndingLindaPhase38(EndingCreditsLinda *arg0) {
    ...
    if (gEndingCreditsSequencePhase == 0x38) {
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)updateEndingLindaSlideToCenter);
    }
}
...
void waitEndingLindaPhase31(EndingCreditsLinda *arg0) {
    ...
    if (gEndingCreditsSequencePhase == 0x31) {
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)updateEndingLindaSlideLeftFromFarRight);
...
void updateEndingLindaAfterIntroAnim1(EndingCreditsLinda *arg0) {
    ...
    addMainMenuSceneModelTexturedDrawCallback(3, arg0->textureId, arg0->paletteId);
    if (sp18 == 1) {
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)updateEndingLindaAfterIntroAnim2);
...
void waitEndingCreditsTumblingSnowboardPhase15(EndingCreditsTumblingSnowboard *arg0) {
    if (gEndingCreditsSequencePhase == 0x15) {
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)updateEndingCreditsTumblingSnowboardBounce);
    }
    addRenderCallback(&gModelRenderCallbackList, (RenderCallback)drawEndingCreditsTumblingSnowboard, arg0);
}
