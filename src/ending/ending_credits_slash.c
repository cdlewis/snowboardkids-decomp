...
void updateEndingSlashFinalPose(EndingCreditsSlashActor *arg0) {
    ...
    if (temp->character.stateTimer < 0x96) {
        temp->character.stateTimer += 1;
        if (temp->character.stateTimer == 0x96) {
...
void updateEndingSlashStartFinalPose(EndingCreditsSlashActor *arg0) {
    ...
    if (l.ret == 1) {
        ...
        if (arg0->character.stateTimer == 0x41) {
            ...
            setMainMenuSceneModelRotation(0, arg0->character.rotation.x, arg0->character.rotation.y, arg0->character.rotation.z);
        }
    }
}
...
void updateEndingSlashPhase40Prep(EndingCreditsSlashActor *arg0) {
    ...
    if (stepMainMenuSceneModelAnimation(0) == 1) {
        temp->character.stateTimer += 1;
        if (temp->character.stateTimer == 0x1E) {
            temp->character.stateTimer = 0;
...
void updateEndingSlashWaitPhase3FAnim(EndingCreditsSlashActor *arg0) {
    ...
    if (l.ret == 1) {
        arg0->character.stateTimer += 1;
        if (arg0->character.stateTimer == 0x14) {
            arg0->character.stateTimer = 0;
...
void updateEndingSlashSpinUntilPhase3F(EndingCreditsSlashActor *arg0) {
    if (stepMainMenuSceneModelAnimation(0) == 0) {
        arg0->character.position.x += 0x18000;
        setMainMenuSceneModelPosition(0, arg0->character.position.x, arg0->character.position.y, arg0->character.position.z);
    }
...
void updateEndingSlashTumbleToPhase3C(EndingCreditsSlashActor *arg0) {
    ...
    arg0->character.position.x += 0x80000;
    arg0->character.position.y += var_v0 * 0x80000;
    arg0->character.stateTimer = arg0->character.stateTimer + 1;
    if (arg0->character.stateTimer == 2) {
...
void updateEndingSlashExitUntilPhase3B(EndingCreditsSlashActor *arg0) {
    ...
    arg0->character.position.x += 0xFFF70000;
...
void updateEndingSlashSlideToCenter(EndingCreditsSlashActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(0);
    temp->character.position.x += 0x24000;
    if (temp->character.position.x >= 0x500000) {
        temp->character.position.x = 0x500000;
        setCallbackTaskCallback(temp, (CallbackTaskCallback)updateEndingSlashSlowRotationWipe);
    }
    setMainMenuSceneModelPosition(0, temp->character.position.x, temp->character.position.y, temp->character.position.z);
    addMainMenuSceneModelDrawCallback(0);
}
...
void updateEndingSlashSlideLeftFromFarRight(EndingCreditsSlashActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(0);
    new_var = arg0;
    var_a1 = (new_var->character.position.x += -0x48000);
    if (var_a1 < -0x1FFFFF) {
        new_var->character.position.x = -0x200000;
    ...
    setMainMenuSceneModelPosition(0, var_a1, arg0->character.position.y, arg0->character.position.z);
    addMainMenuSceneModelDrawCallback(0);
}
...
void updateEndingSlashDashOffLeft(EndingCreditsSlashActor *arg0) {
    ...
    if (arg0->character.position.x < (s32)0xFE700001) {
        arg0->character.position.x = 0xFE700000;
...
void updateEndingSlashVanishRetreat(EndingCreditsSlashActor *arg0) {
    ...
    sp20 = stepMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0xFFF00000;
    arg0->character.stateTimer += 1;
    if (arg0->character.stateTimer < 3) {
        arg0->character.position.y += 0x140000;
    } else {
        arg0->character.position.y += 0xFFEC0000;
    }
    if (arg0->character.stateTimer == 2) {
    ...
    if (sp20 == 1) {
        ...
        setMainMenuSceneModelPosition(0, arg0->character.position.x, 0, arg0->character.position.z);
...
void updateEndingSlashDriftAfterPhase2D(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x2000;
    setMainMenuSceneModelPosition(0, arg0->character.position.x, arg0->character.position.y, arg0->character.position.z);
    addMainMenuSceneModelDrawCallback(0);
...
void updateEndingSlashRunLeftThenPhase2B(EndingCreditsSlashActor *arg0) {
    if (stepMainMenuSceneModelAnimation(0) == 0) {
        arg0->character.position.x += 0xFFF60000;
    } else {
        ...
        arg0->character.position.z = 0xFFFF0000;
...
void updateEndingSlashSlideFarLeft(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0xFFFC8000;
    if (arg0->character.position.x < (s32)0xFFD00001) {
        arg0->character.position.x = 0xFFA00000;
...
void updateEndingSlashSlideRightToPose(EndingCreditsSlashActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(0);
    var_a1 = (arg0->character.position.x += 0x2D000);
    if (var_a1 >= 0x800000) {
...
void updateEndingSlashSlideLeftToMarker(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0xFFFDA000;
    if (arg0->character.position.x < (s32)0xFF700001) {
        arg0->character.position.x = 0xFF700000;
...
void updateEndingSlashSlideRightToMarker(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x1D000;
    if (arg0->character.position.x >= (s32)0xFFCE0000) {
        arg0->character.position.x = 0xFFCE0000;
...
void updateEndingSlashDiagonalSlideSetPhase24(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x28000;
    arg0->character.position.z += 0xFFFE0000;
    if (arg0->character.position.x >= (s32)0xFFC80000) {
        arg0->character.position.x = 0xFFC80000;
...
void waitEndingSlashBeforeDiagonalSlide(EndingCreditsSlashActor *arg0) {
    ...
    addMainMenuSceneModelDrawCallback(0);
    arg0->character.stateTimer += 1;
    if (arg0->character.stateTimer == 0x32) {
        arg0->character.stateTimer = 0;
...
void updateEndingSlashSlideRightSetPhase23(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x28000;
    if (arg0->character.position.x >= (s32)0xFF700000) {
        arg0->character.position.x = 0xFF700000;
        arg0->character.stateTimer = 0;
...
void updateEndingSlashExitLeftAfterPhase22(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0xFFFA0000;
    if (arg0->character.position.x < (s32)0xFE700001) {
        arg0->character.position.x = 0xFE700000;
...
void updateEndingSlashSlideLeftUntilPhase18(EndingCreditsSlashActor *arg0) {
    stepMainMenuSceneModelAnimation(0);
    addMainMenuSceneModelDrawCallback(0);
    arg0->character.position.x += 0xFFFD0000;
...
void updateEndingSlashSlideRightToIdle(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x30000;
    if (arg0->character.position.x >= 0xD0000) {
        arg0->character.position.x = 0xD0000;
...
void updateEndingSlashWaitBeforeIdleAnim2(EndingCreditsSlashActor *arg0) {
    ...
    if (stepMainMenuSceneModelAnimation(0) == 1) {
        temp->character.stateTimer += 1;
        if (temp->character.stateTimer == 0xF) {
            temp->character.stateTimer = 0;
...
void updateEndingSlashHopLeftAnim(EndingCreditsSlashActor *arg0) {
    ...
    arg0->character.position.x += 0xFFF80000;
    arg0->character.position.y += var_v0 * 0x60000;
    arg0->character.stateTimer = arg0->character.stateTimer + 1;
    setMainMenuSceneModelPosition(0, arg0->character.position.x, arg0->character.position.y, arg0->character.position.z);
    addMainMenuSceneModelDrawCallback(0);
    if (sp20 == 1) {
...
void updateEndingSlashSlideRightBurst(EndingCreditsSlashActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(0);
    var_a1 = (arg0->character.position.x += 0x40000);
    if (var_a1 >= 0x280000) {
        arg0->character.position.x = 0x280000;
        setMainMenuSceneModelAnimation(0, 0x20);
...
void waitEndingSlashRotationPhase14(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    addMainMenuSceneModelDrawCallback(0);
    if (arg0->character.stateTimer < 0x10) {
        arg0->character.stateTimer += 1;
        if (arg0->character.stateTimer == 0x10) {
...
void updateEndingSlashSlideLeftSlowRotation(EndingCreditsSlashActor *arg0) {
    arg0->character.position.x += -0x20000;
    arg0->character.stateTimer += 1;
    if ((arg0->character.stateTimer % 13) == 0) {
        gEndingCreditsTransitionSnowboardIconSpinStep -= 1;
    }
    if (arg0->character.position.x < -0x9FFFFF) {
        gEndingCreditsTransitionSnowboardIconSpinStep = 2;
        arg0->character.stateTimer = 0;
        arg0->character.position.x = -0xA00000;
...
void updateEndingSlashWaitRotationStepTen(EndingCreditsSlashActor *arg0) {
    ...
    if (gEndingCreditsTransitionSnowboardIconSpinStep != 0xA) {
        ...
        arg0->character.stateTimer += 1;
        if (arg0->character.stateTimer == 1) {
            arg0->character.stateTimer = 0;
...
void updateEndingSlashSlideRightSetPhase11(EndingCreditsSlashActor *arg0) {
    loopMainMenuSceneModelAnimation(0);
    arg0->character.position.x += 0x60000;
    arg0->character.stateTimer += 1;
    if (arg0->character.position.x >= 0x300000) {
        arg0->character.stateTimer = 0;
        arg0->character.position.x = 0x300000;
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)waitEndingSlashPhase12);
    }
    if (arg0->character.stateTimer == 0x18) {
...
void waitEndingSlashPhase10Aura(EndingCreditsSlashActor *arg0) {
    if (gEndingCreditsSequencePhase == 0x10) {
        ...
        setMainMenuSceneModelPosition(0, -0x1900000, arg0->character.position.y, arg0->character.position.z);
        setMainMenuSceneModelRotation(0, arg0->character.rotation.x, arg0->character.rotation.y, arg0->character.rotation.z);
...
void updateEndingSlashVanishBeforeExitRight(EndingCreditsSlashActor *arg0) {
    ...
    if (stepMainMenuSceneModelAnimation(0) == 1) {
        temp = ++arg0->character.stateTimer;
        if ((u32)temp == 0x19) {
            arg0->character.stateTimer = 0;
...
void updateEndingSlashWaitRisingStar(EndingCreditsSlashActor *arg0) {
    if (stepMainMenuSceneModelAnimation(0) == 1) {
        ...
        arg0->character.stateTimer += 1;
        if (arg0->character.stateTimer == 0x23) {
            arg0->character.stateTimer = 0;
...
void waitEndingSlashBeforeRisingStar(EndingCreditsSlashActor *arg0) {
    addMainMenuSceneModelDrawCallback(0);
    arg0->character.stateTimer += 1;
    if (arg0->character.stateTimer == 0x19) {
        arg0->character.stateTimer = 0;
...
void updateEndingSlashRepeatAnim17(EndingCreditsSlashActor *arg0) {
    if (stepMainMenuSceneModelAnimation(0) == 1) {
        arg0->character.stateTimer += 1;
        if (arg0->character.stateTimer < 0xA) {
...
void updateEndingSlashLongWaitSetShadow(EndingCreditsSlashActor *arg0) {
    ...
    temp_a2 = arg0;
    arg0->character.stateTimer++;
    if (arg0->character.stateTimer == 6) {
        gEndingCreditsSequencePhase = 9;
    }
    if (arg0->character.stateTimer == 0x64) {
        ...
        temp_a2->character.stateTimer = 0;
        gEndingActorShadow.characterId = 0;
...
void updateEndingSlashSlideLeftToAura(EndingCreditsSlashActor *arg0) {
    ...
    temp_a1 = (arg0->character.position.x += 0xFFFA0000);
    if (temp_a1 < 0x580001) {
        arg0->character.position.x = 0x580000;
        ...
        setMainMenuSceneModelPosition(0, temp_a1, arg0->character.position.y, arg0->character.position.z);
        loopMainMenuSceneModelAnimation(0);
    }
    addMainMenuSceneModelDrawCallback(0);
}
...
void updateEndingSlashEnterFromRight(EndingCreditsSlashActor *arg0) {
    ...
    temp_a1 = (arg0->character.position.x += 0xFFFD8FD8);
    if (temp_a1 < 0x900001) {
        arg0->character.position.x = 0x900000;
