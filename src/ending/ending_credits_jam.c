...
void updateEndingJamStartFinalPose(EndingCreditsCharacterActor *arg0) {
    ...
    if (gEndingCreditsSequencePhase == 0x41) {
        ...
        setMainMenuSceneModelRotation(2, arg0->rotation.x, arg0->rotation.y, arg0->rotation.z);
    }
}
...
void updateEndingJamHopRightToIdle(EndingCreditsCharacterActor *arg0) {
    ...
    arg0->position.x += 0x5D000;
    arg0->position.y += var_v0 * 0x60000;
    arg0->stateTimer = arg0->stateTimer + 1;
    setMainMenuSceneModelPosition(2, arg0->position.x, arg0->position.y, arg0->position.z);
    addMainMenuSceneModelDrawCallback(2);
    if (sp20 == 1) {
        arg0->stateTimer = 0;
...
void updateEndingJamSlideLeftSetPhase3B(EndingCreditsCharacterActor *arg0) {
    ...
    if (arg0->position.x < (s32)0xFFA00001) {
...
void updateEndingJamSlideLeftFromFarRight(EndingCreditsCharacterActor *arg0) {
    ...
    setMainMenuSceneModelPosition(2, var_a1, arg0->position.y, arg0->position.z);
    addMainMenuSceneModelDrawCallback(2);
}
...
void updateEndingJamVanishRetreat(EndingCreditsCharacterActor *arg0) {
    ...
    if (sp20 == 1) {
        ...
        arg0->position.y = 0;
        setMainMenuSceneModelPosition(2, arg0->position.x, 0, arg0->position.z);
...
void updateEndingJamDriftAfterPhase2D(EndingCreditsCharacterActor *arg0) {
    loopMainMenuSceneModelAnimation(2);
    arg0->position.x = arg0->position.x + 0x2000;
    setMainMenuSceneModelPosition(2, arg0->position.x, arg0->position.y, arg0->position.z);
    addMainMenuSceneModelDrawCallback(2);
...
void updateEndingJamRunLeftThenPhase2C(EndingCreditsCharacterActor *arg0) {
    if (stepMainMenuSceneModelAnimation(2) == 0) {
        arg0->position.x = arg0->position.x + 0xFFF60000;
    } else {
...
void updateEndingJamSlideFarLeft(EndingCreditsCharacterActor *arg0) {
    ...
    arg0->position.z += 0xFFFF0000;
    if (arg0->position.x < (s32)0xFFA80001) {
        arg0->position.x = 0xFF780000;
...
void waitEndingJamPhase2A(EndingCreditsCharacterActor *arg0) {
    ...
    if (gEndingCreditsSequencePhase == 0x2A) {
        ...
        arg0->position.z = 0xFFFC0000;
    }
}

void updateEndingJamSlideRightToPose(EndingCreditsCharacterActor *arg0) {
    loopMainMenuSceneModelAnimation(2);
    arg0->position.x += 0x2D000;
    if (arg0->position.x >= 0xF00000) {
        arg0->position.x = 0xF00000;
...
void updateEndingJamSlideRightToMarker(EndingCreditsCharacterActor *arg0) {
    loopMainMenuSceneModelAnimation(2);
    arg0->position.x += 0x2E000;
    if (arg0->position.x >= (s32)0xFFD00000) {
        arg0->position.x = 0xFFD00000;
...
void updateEndingJamSlideLeftToMarker(EndingCreditsCharacterActor *arg0) {
    loopMainMenuSceneModelAnimation(2);
    arg0->position.x += 0xFFFD2000;
    if (arg0->position.x < (s32)0xFF800001) {
        arg0->position.x = 0xFF800000;
...
void updateEndingJamSlideRightToPhase27Start(EndingCreditsCharacterActor *arg0) {
    ...
    if (arg0->position.x >= (s32)0xFFD80000) {
        arg0->position.x = 0xFFD80000;
...
void updateEndingJamSlideLeftSetPhase25(EndingCreditsCharacterActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(2);
    var_a1 = (arg0->position.x += 0xFFFD4000);
    if (var_a1 < (s32)0xFF550001) {
        arg0->position.x = 0xFF550000;
        setCallbackTaskCallback(arg0, (CallbackTaskCallback)startEndingJamPhase26Slide);
        gEndingCreditsSequencePhase = 0x25;
        var_a1 = arg0->position.x;
    }
    temp_a2 = &arg0->position.y;
    setMainMenuSceneModelPosition(2, var_a1, *temp_a2, arg0->position.z);
    addMainMenuSceneModelDrawCallback(2);
}
...
void updateEndingJamDiagonalSlideSetPhase22(EndingCreditsCharacterActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(2);
    var_a1 = (arg0->position.x -= -0x28000);
...
void updateEndingJamExitLeftAfterPhase21(EndingCreditsCharacterActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(2);
    var_a1 = (arg0->position.x += 0xFFFA0000);
...
void updateEndingJamAfterVanishWait(EndingCreditsCharacterActor *arg0) {
    ...
    loopMainMenuSceneModelAnimation(2);
    var_a1 = (arg0->position.x += 0xFFFB0000);
    if (var_a1 < (s32)0xFF600001) {
        arg0->position.x = 0xFF600000;
...
void updateEndingJamWaitBeforePhase1C(EndingCreditsCharacterActor *arg0) {
    ...
    if (*p == 0x1E) {
        *p = 0;
        ...
        arg0->position.z = 0xFFFF0000;
        setMainMenuSceneModelPosition(2, arg0->position.x, arg0->position.y, 0xFFFF0000);
    }
}
...
void updateEndingJamStepBackAfterHandshake(EndingCreditsCharacterActor *arg0) {
    if (stepMainMenuSceneModelAnimation(2) == 1) {
        ...
        arg0->position.z = arg0->position.z + 0xFFFC0000;
        setMainMenuSceneModelPosition(2, arg0->position.x, arg0->position.y, arg0->position.z);
    }
    addMainMenuSceneModelDrawCallback(2);
}
...
void updateEndingJamSlideRightUntilPhase18(EndingCreditsCharacterActor *arg0) {
    stepMainMenuSceneModelAnimation(2);
    addMainMenuSceneModelDrawCallback(2);
    arg0->position.x = arg0->position.x + 0x30000;
...
void waitEndingJamPhase17(EndingCreditsCharacterActor *arg0) {
    ...
    val = arg0->stateTimer;
    if (val < 0x2D) {
        arg0->stateTimer = val + 1;
        if (arg0->stateTimer == 0x2D) {
...
void updateEndingJamSlideLeftToIdle(EndingCreditsCharacterActor *arg0) {
    loopMainMenuSceneModelAnimation(2);
    arg0->position.x = arg0->position.x + 0xFFFD0000;
    if (arg0->position.x < 0x4E0001) {
        arg0->position.x = 0x4E0000;
...
void updateEndingJamSlideLeftToPhase15Wait(EndingCreditsCharacterActor *arg0) {
    arg0->position.x = arg0->position.x + 0xFFFB8000;
    if (arg0->position.x < 0x500001) {
        arg0->position.x = 0x500000;
...
void waitEndingJamPhase13(EndingCreditsCharacterActor *arg0) {
    if (gEndingCreditsSequencePhase == 0x13) {
        ...
        spawnEndingCreditsTumblingSnowboard(arg0->position.x + 0x48000, 0x480000, 0xFFF30000, 2, 2, 1);
    }
}

void initEndingCreditsJam(EndingCreditsCharacterActor *arg0) {
    arg0->position.x = 0x3248000;
    arg0->position.y = 0;
    arg0->position.z = 0;
    arg0->rotation.x = 0;
    arg0->rotation.y = 0x400;
