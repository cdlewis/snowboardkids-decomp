...
extern void func_80039E5C(Struct3A0E0 *);
extern void func_8003B430(void);
extern void func_80039CEC(Struct3A0E0 *);
extern void func_8003A46C(Struct3A0E0 *);
...
extern void func_8003A9E0(void *);
...
void func_80039CEC(Struct3A0E0 *arg0) {
    s32 sp;
    s32 temp;

    sp = func_80041FB4(3);
    if (sp == 0) {
        arg0->unk18 += 0xFFFF6000;
    } else {
        temp = (arg0->unk2A += 1);
        if ((temp % 28) == 0) {
            if ((temp / 28) == 3) {
                func_80071824((s32)arg0, func_80039C84);
                D_8010B1A2 = 0x2E;
            } else {
...
void func_80039E5C(Struct3A0E0 *arg0) {
    s32 sp;
    ...
    if ((sp == 1) && (arg0->unk18 < 0x800001)) {
        *(u16 *)((char *)arg0 + 0x2A) = 0;
        func_80071824((s32)arg0, (void (*)(void))func_80039E08);
        D_8010B1A2 = 0x2D;
...
void func_8003A46C(Struct3A0E0 *arg0) {
    u16 temp_t8;
    s32 sp20;
    ...
    if (D_8010B1A2 == 0x20) {
        arg0->unk2A = 0;
        func_80071824((s32)arg0, func_8003A3E0);
        func_80041DD4(3, 0x4B);
    }
}
...
void func_8003A538(void *arg0) {
    func_8004298C(3, *(u16 *)((char *)arg0 + 0x2E), *(u16 *)((char *)arg0 + 0x30), 0xB);
    if (D_8010B1A2 == 0x1D) {
        func_80071824((s32)arg0, (void (*)(void))func_8003A46C);
        func_80041DD4(3, 0x4A);
    }
}
...
void func_8003AC00(void *arg0) {
    func_800428C8(3);
    if ((D_8010B1A4 == 1) || (D_8010B1A4 == 3)) {
        func_80071824((s32)arg0, func_8003A9E0);
        if (D_8010B1A4 == 1) {
            *(s16 *)((u8 *)arg0 + 0x26) = 0x400;
            if (*(u16 *)((u8 *)arg0 + 0x2A) == 0xF) {
                func_80041DD4(3, 0x39);
                *(u16 *)((u8 *)arg0 + 0x2A) = 2;
                *(s32 *)((u8 *)arg0 + 0x1C) = 0x120000;
            } else {
...
void func_8003ADC0(void *arg0) {
    s32 var_a1;

    func_80042034(3);
    func_800428C8(3);
    var_a1 = *(s32 *)((char *)arg0 + 0x18) += (s32)0xFFFD0000;
    *(s32 *)((char *)arg0 + 0x20) = *(s32 *)((char *)arg0 + 0x20) + (s32)0xFFFF0000;
    if (var_a1 < 0x2D0001) {
        *(s32 *)((char *)arg0 + 0x18) = 0x2D0000;
        *(s32 *)((char *)arg0 + 0x20) = (s32)0xFFFE0000;
        func_80071824((s32)arg0, (void (*)(void))func_8003AD40);
        func_80041DD4(3, 0x38);
        D_8010B1A2 = 0x17;
        *(s16 *)((char *)arg0 + 0x26) = 0x400;
        func_800420FC(3, *(s16 *)((char *)arg0 + 0x24), *(s16 *)((char *)arg0 + 0x26), *(s16 *)((char *)arg0 + 0x28));
        var_a1 = *(s32 *)((char *)arg0 + 0x18);
    }
