void drawCharacterSelectCourseRecordsPopup(CharacterSelectCourseWidgetActor *actor) {
    ...
    for (rowIndex = 0; rowIndex < 5; rowIndex++) {
        ...
        drawMenuSprite(actor->x, actor->y + (0x14 * rowIndex), getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                       rowIndex + 0x77, 0x20, 0x20, 0, 0);
        if (gPlayerCount == 1) {
            if (gRaceSplitscreenMode != 2) {
                if (gRaceTypeSelection == 0) {
                    ...
                    drawCharacterSelectCourseRecordTime(
                        ...
                        actor->x + 0x14, actor->y + (0x14 * rowIndex), rowPalette);
                    drawMenuSprite(
                        actor->x + 0x54, actor->y + (0x14 * rowIndex),
                        ...
                        0x20, 0x20, 0, 0);
                    drawMenuSprite(
                        actor->x + 0x65, actor->y + (0x14 * rowIndex),
                        getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                        (gGameSaveDataBuffer
                             ->raceRecordCharacterIds[courseOptions[gRaceCourseIndex.signedValue]][rowIndex] >>
                         3) +
                    ...
                    digits[0] =
                        gGameSaveDataBuffer
                            ->scoreAttackScores[courseOptions[gRaceCourseIndex.signedValue]][rowIndex] /
                        10;
                    if (digits[0]) {
                        drawMenuSprite(actor->x + 0x18, actor->y + (0x14 * rowIndex),
                                       getRelocatableHeapBlockBase((s32)gAssetHandles[0x1F]),
                                       digits[0] + 0x2B, 0x20, 0x20, 0, recordPalette + 1);
                    }
                    digits[1] =
                        gGameSaveDataBuffer
                            ->scoreAttackScores[courseOptions[gRaceCourseIndex.signedValue]][rowIndex] %
                    ...
                    drawMenuSprite(actor->x + 0x20, actor->y + (0x14 * rowIndex),
                                   getRelocatableHeapBlockBase(gAssetHandles[0x1F]), digits[1] + 0x2B,
                                   0x20, 0x20, 0, recordPalette + 1);
                    drawMenuAsciiText(actor->x + 0x28, (actor->y + (0x14 * rowIndex)) + 8, "HIT",
                                      rowPalette, 0x100);
                    drawMenuSprite(
                        actor->x + 0x48, actor->y + (0x14 * rowIndex),
                        getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                        (gGameSaveDataBuffer
                        ...
                        0x20U, 0x20U, 0U, 0U);
                    drawMenuSprite(
                        actor->x + 0x60, actor->y + (0x14 * rowIndex),
                        getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                        (gGameSaveDataBuffer
                             ->scoreAttackCharacterIds[courseOptions[gRaceCourseIndex.signedValue]][rowIndex] >>
                         3) +
                    ...
                    for (digitOffset = 0;;) {
                        drawMenuSprite((s16)((actor->x - digitOffset) + 0x38),
                                       (s16)(actor->y + (0x14 * rowIndex)),
                                       getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                                       (remainingScore % 10) + 0x2B, 0x20U, 0x20U, 0U,
                                       recordPalette + 1);
                        digitOffset += 8;
                        remainingScore /= 10;
                        if (remainingScore == 0) {
                    ...
                    drawMenuAsciiText(actor->x + 0x40, (actor->y + (0x14 * rowIndex)) + 8, "P",
                                      rowPalette, 0x100U);
                    drawMenuSprite(
                        actor->x + 0x4C, actor->y + (0x14 * rowIndex),
                        getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
                ...
                drawCharacterSelectCourseRecordTime(
                    (CharacterSelectCourseRecordTime *)
                        &gGameSaveDataBuffer
                             ->timeTrialRecords[courseOptions[gRaceCourseIndex.signedValue]][rowIndex],
                    actor->x + 0x14, actor->y + (0x14 * rowIndex), rowPalette);
                drawMenuSprite(
                    actor->x + 0x54, actor->y + (0x14 * rowIndex),
                    getRelocatableHeapBlockBase(gAssetHandles[0x1F]),
