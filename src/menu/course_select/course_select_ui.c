...
MenuGlyphScript D_800B6BE0[] = { 0x001D, 0xFFFF };

CourseModeDescriptionText gCourseSelectModeDescriptionText[7] = {
    { { 0xFFFC, 0x0007, 0x001C, 0x0015, 0x0018, 0x0020, 0x002A, 0xFFFE, 0x000B, 0x001E, 0x001D,
        0xFFFE, 0x000E, 0x000A, 0x001C, 0x0022, 0xFFFD, 0x001D, 0x0018, 0xFFFE, 0x000C, 0x0018,
        0x0017, 0x001D, 0x001B, 0x0018, 0x0015, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x000B, 0x000A, 0x0015, 0x000A, 0x0017, 0x000C, 0x000E, 0x000D, 0xFFFD,
        0x000B, 0x0018, 0x000A, 0x001B, 0x000D, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x000F, 0x000A, 0x001C, 0x001D, 0x002A, 0xFFFE, 0x000B, 0x001E, 0x001D,
        0xFFFE, 0x0011, 0x000A, 0x001B, 0x000D, 0xFFFD, 0x001D, 0x0018, 0xFFFE, 0x000C, 0x0018,
        0x0017, 0x001D, 0x001B, 0x0018, 0x0015, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x001B, 0x000E, 0x001D, 0x001E, 0x001B, 0x0017, 0xFFFE, 0x001D, 0x0018,
        0xFFFD, 0x000C, 0x0018, 0x001E, 0x001B, 0x001C, 0x000E, 0xFFFE, 0x001C, 0x000E, 0x0015,
        0x000E, 0x000C, 0x001D, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x001B, 0x000E, 0x001D, 0x001E, 0x001B, 0x0017, 0xFFFE, 0x001D, 0x0018,
        0xFFFD, 0x001C, 0x0011, 0x0018, 0x0019, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x000A, 0xFFFE, 0x001F, 0x000E, 0x001B, 0x0022, 0xFFFE, 0x001C, 0x0019,
        0x000E, 0x000C, 0x0012, 0x000A, 0x0015, 0xFFFD, 0x000B, 0x0018, 0x000A, 0x001B, 0x000D,
        0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000 } },
...
MenuGlyphScript gCourseSelectBoardLevelText[] = {
    0xFFFC, 0x0007, 0x001C, 0x000E, 0x0015, 0x000E, 0x000C, 0x001D, 0xFFFD, 0x000B, 0x0018,
    0x000A, 0x001B, 0x000D, 0xFFFD, 0x0015, 0x000E, 0x001F, 0x000E, 0x0015, 0x002C, 0xFFFF,
};

CourseBoardLevelByCourseText gCourseSelectBoardLevelByCourseText[4] = {
    { { 0xFFFC, 0x0006, 0xFFFE, 0x000F, 0x001B, 0x000E, 0x000E, 0xFFFE, 0x001C, 0x001D, 0x0022,
        0x0015, 0x000E, 0xFFFD, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0015, 0x000E, 0x001F, 0x000E,
        0x0015, 0xFFFF } },
    { { 0xFFFC, 0x0006, 0xFFFE, 0xFFFE, 0x000A, 0x0015, 0x0015, 0xFFFE, 0x001B, 0x0018, 0x001E,
        0x0017, 0x000D, 0xFFFD, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0015, 0x000E, 0x001F, 0x000E,
        0x0015, 0xFFFF } },
    { { 0xFFFC, 0x0006, 0xFFFE, 0xFFFE, 0xFFFE, 0x000A, 0x0015, 0x0019, 0x0012, 0x0017, 0x000E,
        0xFFFD, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x0015, 0x000E, 0x001F, 0x000E, 0x0015, 0xFFFF,
        0x0000, 0x0000 } },
...
CourseExtraBoardLevelText gCourseSelectExtraCourseBoardLevelText[3] = {
    { { 0xFFFC, 0x0007, 0x000F, 0x000A, 0x001C, 0x001D, 0xFFFE, 0x000A, 0x0017, 0x000D, 0xFFFE,
        0x000E, 0x000A, 0x001C, 0x0022, 0xFFFD, 0x001D, 0x0018, 0xFFFE, 0x000C, 0x0018, 0x0017,
        0x001D, 0x001B, 0x0018, 0x0015, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x001C, 0x0019, 0x000E, 0x000C, 0x0012, 0x000A, 0x0015, 0xFFFE, 0x000B,
        0x0018, 0x000A, 0x001B, 0x000D, 0xFFFD, 0x000F, 0x0018, 0x001B, 0xFFFE, 0x001D, 0x001B,
        0x0012, 0x000C, 0x0014, 0x001C, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x000B, 0x0018, 0x000A, 0x001B, 0x000D, 0xFFFE, 0x001D, 0x0011, 0x000A,
        0x001D, 0xFFFE, 0x0012, 0x001C, 0xFFFD, 0x001E, 0x001C, 0x000E, 0x0015, 0x000E, 0x001C,
        0x001C, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000 } },
};

CoursePurchaseMessageText gCourseSelectPurchaseMessageText[2] = {
    { { 0xFFFC, 0x0007, 0x0017, 0x0018, 0x001D, 0xFFFE, 0x000E, 0x0017, 0x0018, 0x001E, 0x0010,
        0x0011, 0xFFFD, 0x0016, 0x0018, 0x0017, 0x000E, 0x0022, 0x002C, 0xFFFF, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000 } },
    { { 0xFFFC, 0x0007, 0x0018, 0x001E, 0x001D, 0xFFFE, 0x0018, 0x000F, 0xFFFD, 0x001C, 0x001D,
        0x0018, 0x000C, 0x0014, 0x002C, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000 } },
};

MenuGlyphScript gCourseSelectCompleteText[] = {
    0xFFFC, 0x0007, 0x001C, 0x000E, 0x0015, 0x000E, 0x000C, 0x001D, 0x0012, 0x0018, 0x0017,
    0xFFFD, 0x000C, 0x0018, 0x0016, 0x0019, 0x0015, 0x000E, 0x001D, 0x000E, 0x002C, 0xFFFF,
};
...
void updateCourseSelectPreviewModelIn(CourseSelectAnimatedActor *arg0)
{
    ...
    if ((gRacePlayers[0].menuState == 4) || (actor->state[0] == 9)) {
        ...
        addRenderCallback(&gModelRenderCallbackList, (RenderCallback)(void (*)(CourseSelectWidgetActor *))drawCourseSelectPreviewModel,
...
void drawCourseSelectCourseStats(CourseSelectWidgetActor *arg0) {
 ...
 drawMenuAsciiText((s16) (arg0->courseStatsX[i] + 0x34), arg0->courseStatsY[i], text, 0, arg0->courseStatsAlpha); if (selectedCourseId < 9) { sprintf((char *)text, D_800E0DB0, gCourseSelectCourseRatings.courses[selectedCourseId].handling); } drawMenuAsciiText((s16) (arg0->courseStatsX[i] + 0x34), (s16) (arg0->courseStatsY[i] + 8), text, 0, arg0->courseStatsAlpha); if (selectedCourseId < 9) { sprintf((char *)text, D_800E0DB4, gCourseSelectCourseRatings.courses[selectedCourseId].trick); } drawMenuAsciiText((s16) (arg0->courseStatsX[i] + 0x34), (s16) ((unsigned short) (arg0->courseStatsY[i] + 0x10)), text, 0, arg0->courseStatsAlpha); } if (((s32) gPlayerCount) >= 2) { if (((s32) gPlayerCount) == 2) { j = 0; } else { j = 1; } drawMenuSpriteWithAlpha((s16) (gCourseSelectStatsPlayerMarkerLayout[j][i & 1][0] + ((i >= 2) * 0x8C)), gCourseSelectStatsPlayerMarkerLayout[j][i & 1][1], getRelocatableHeapBlockBase(gAssetHandles[0x21]), 0x12, 0x20, 0x20, new_var, arg0->courseStatsAlpha, 0); } } i++; } while (i < ((s32) gPlayerCount)); } } while (0);
    } while (0);
}
#endif
            ...
            if (gPlayerCount < 3) {
                if (courseIndex >= 9) {
                    ...
                    if (j < gCourseSelectCourseRatings
                                .values[(courseIndex * COURSE_RATING_COUNT) + COURSE_RATING_SPEED]) {
                        xOffset = 0;
                        do {
                            drawMenuSpriteWithAlpha(
                ...
                if (courseIndex >= 9) {
                    ...
                    j = 0;
                    if (j < gCourseSelectCourseRatings
                                .values[(courseIndex * COURSE_RATING_COUNT) + COURSE_RATING_TRICK]) {
                        xOffset = 0;
                        do {
                            drawMenuSpriteWithAlpha(
                                (s16)(arg0->courseStatsX[i] + xOffset + 0x38),
    ...
    if (gCourseSelectStatus.purchaseMessage == 0) {
        ...
        if ((gRaceSplitscreenMode == 3) &&
            ...
            if (gCourseSelectModeSelection == 0) {
                ...
                drawMenuGlyphScript(arg0->x + 0x20, arg0->y + 0x20, script, 1,
                                    (u16)descriptionIndex, 0);
            }
        }
    } else {
                        ...
                        if (gRacePlayers[playerIndex].selectedCharacterId == 5) {
                            ...
                            for (iconIndex = 0; iconIndex < 3; iconIndex++) {
                                if (gRacePlayers[playerIndex].menuSelection >= 9) {
                                    if (gRaceSplitscreenMode == 3) {
                                        if (gGameSaveDataBuffer[playerIndex].extraCourseUnlockFlags &
                                            iconMask) {
                                            actor->itemCounts[playerIndex]++;
                                            if (gPlayerCount == 1) {
                                        ...
                                        iconMask *= 2;
                                    } else if (gGameSaveDataBuffer[playerIndex].courseUnlockStates[iconIndex + 9] != -1) {
                                        actor->itemCounts[playerIndex]++;
                                        if (gPlayerCount == 1) {
                                            actor->tileIndices[playerIndex][actor->itemCounts[playerIndex] - 1] =
                                                iconIndex + 0xC;
