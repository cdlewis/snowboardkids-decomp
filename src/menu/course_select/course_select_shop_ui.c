...
ShopMenuFrameTileMap gShopMenuPanelFrameTilemaps[2] = {
    ...
    0x001E, 0x0027, 0x002C, 0x002D, 0x002E, 0x00A4, 0x00A5, 0x00A6,
    0x00A7, 0x00A9, 0x00AA, 0x00AB, 0x00AC, 0x00AD, 0x00AE, 0x00AF,
    0x00B0, 0x00B2, 0x00B3, 0x00B4, 0x00B5, 0x00A8, 0x00B1, 0x00B6,
    0x00B7, 0x00B8,
};

ShopDescriptionText gShopMenuModeDescriptionText[5] = {
    0xFFFC, 0x0006, 0x000B, 0x001E, 0x0022, 0xFFFE, 0x0018, 0x0017,
    0x000E, 0xFFFC, 0x0007, 0x002C, 0xFFFD, 0x0022, 0x0018, 0x001E,
    0xFFFE, 0x000C, 0x000A, 0x0017, 0x0027, 0x001D, 0xFFFD, 0x000B,
    0x001E, 0x0022, 0xFFFE, 0x0018, 0x0017, 0x000E, 0xFFFE, 0x0022,
    0x0018, 0x001E, 0xFFFD, 0x000A, 0x0015, 0x001B, 0x000E, 0x000A,
    0x000D, 0x0022, 0xFFFD, 0x0011, 0x000A, 0x001F, 0x000E, 0x002C,
    0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFFFC, 0x0006,
    0x000C, 0x0011, 0x000A, 0x0017, 0x0010, 0x000E, 0xFFFD, 0x000C,
    0x0018, 0x0015, 0x0018, 0x001B, 0xFFFC, 0x0007, 0x002C, 0xFFFD,
    0x000F, 0x001B, 0x000E, 0x000E, 0xFFFE, 0x0018, 0x000F, 0xFFFD,
    0x000C, 0x0011, 0x000A, 0x001B, 0x0010, 0x000E, 0x002C, 0xFFFF,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0xFFFC, 0x0007, 0x0015, 0x000E,
    0x000A, 0x001F, 0x000E, 0xFFFE, 0x001C, 0x0011, 0x0018, 0x0019,
    0xFFFD, 0x000A, 0x0017, 0x000D, 0xFFFE, 0x001B, 0x000E, 0x001D,
    0x001E, 0x001B, 0x0017, 0xFFFD, 0x001D, 0x0018, 0xFFFE, 0x001D,
    0x0011, 0x000E, 0xFFFD, 0x0016, 0x000A, 0x0012, 0x0017, 0xFFFE,
    0x0016, 0x000E, 0x0017, 0x001E, 0x002C, 0xFFFF, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0xFFFC, 0x0007, 0x0020, 0x000E, 0x0015, 0x000C,
    0x0018, 0x0016, 0x000E, 0x0024, 0xFFFF, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    ...
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0xFFFC, 0x0007, 0x0020, 0x000E, 0xFFFE, 0x0011, 0x000A, 0x001F,
    0x000E, 0xFFFD, 0x0010, 0x001B, 0x000E, 0x000A, 0x001D, 0xFFFD,
    0x000B, 0x0018, 0x000A, 0x001B, 0x000D, 0x001C, 0xFFFE, 0x0012,
    0x0017, 0xFFFD, 0x001C, 0x001D, 0x0018, 0x000C, 0x0014, 0x002C,
    0xFFFE, 0x0020, 0x000A, 0x0017, 0x0017, 0x000A, 0xFFFD, 0x000B,
    0x001E, 0x0022, 0xFFFE, 0x0018, 0x0017, 0x000E, 0x0030, 0xFFFF,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
...
MenuGlyphScript gCourseUnlockPurchasePromptText[24] = {
    0x0012, 0x001C, 0xFFFE, 0x001D, 0x0011, 0x0012, 0x001C, 0xFFFE,
    0x0018, 0x0014, 0x0030, 0xFFFF, 0x000B, 0x0018, 0x000A, 0x001B,
    0x000D, 0xFFFE, 0x001C, 0x0011, 0x0018, 0x0019, 0xFFFF, 0x0000,

};

CourseDetailsMenuEntryTilePages gCourseDetailsMenuEntryTiles = {
    0x000F, 0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0016, 0x0017,
    0x0018, 0x000C, 0x000D, 0x000E, 0x0015, 0x0019,
};

ShopMenuSparklePattern gShopMenuSparklePatterns[5] = {
    0x0000, 0x0000, 0xFFF0, 0x0010, 0xFFE0, 0x0020, 0x0000, 0x0020,
    0x0020, 0x0020, 0xFFE0, 0x0040, 0x0000, 0x0040, 0xFFF0, 0x0060,
    0xFFF0, 0x0070, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0010, 0xFFE0, 0x0020,
    0xFFF0, 0x0020, 0xFFF0, 0x0030, 0xFFF0, 0x0040, 0xFFF0, 0x0050,
    0x0010, 0x0050, 0xFFF0, 0x0070, 0x0010, 0x0070, 0xFFFF, 0xFFFF,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0010, 0xFFF0,
    0xFFE0, 0x0010, 0xFFF0, 0x0010, 0x0010, 0x0010, 0xFFF0, 0x0030,
    0x0010, 0x0030, 0xFFF0, 0x0050, 0x0010, 0x0050, 0xFFFF, 0xFFFF,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0010, 0xFFF0, 0x0030, 0xFFF0, 0x0010, 0x0010, 0x0030, 0x0010,
    0x0020, 0x0030, 0x0010, 0x0040, 0x0010, 0x0050, 0x0030, 0x0050,
    0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0020, 0x0000, 0xFFF0, 0x0020, 0x0000, 0x0020,
    0x0020, 0x0020, 0x0040, 0x0000, 0x0000, 0x0040, 0x0020, 0x0040,
    0x0010, 0x0060, 0x0010, 0x0070, 0x0040, 0x0040, 0x0010, 0x0080,
    0xFFFF, 0xFFFF,
};
...
ShopMenuSparkleOffset gCoursePreviewCloseSparkleOffsets[6] = {
    0x0003, 0xFFFC, 0x000C, 0xFFFE, 0x0013, 0xFFFD, 0x001D, 0xFFFD,
    0x0023, 0xFFFF, 0x002A, 0xFFFB,
};
...
void drawShopMenuSparkles(ShopMenuWidgetActor *arg0) {
    ...
    if (gShopMenuSparklePatterns[actor->sparkle.patternIndex][0].x != -1) {
        ...
        do {
            drawActor = actor;
            drawMenuSpriteTile(
                (s16)(drawActor->randomValues[0] + gShopMenuSparklePatterns[drawActor->sparkle.patternIndex][patternOffset].x),
                (s16)(drawActor->randomValues[1] + gShopMenuSparklePatterns[drawActor->sparkle.patternIndex][patternOffset].y),
                getRelocatableHeapBlockBase(gAssetHandles[0x27]), tileIndex + drawActor->sparkle.tileBase, 0, drawActor->sparkle.alpha);
            patternOffset++;
            tileIndex++;
...
void drawCourseUnlockPurchasePrompt(ShopMenuWidgetActor *arg0) {
    ...
    drawMenuSpriteWithAlpha((s16)(arg0->x + 0x50), (s16)(arg0->y + 0x24), getRelocatableHeapBlockBase(gAssetHandles[0x24]), 0x18,
                            0x20, 0x20, 0, alpha, 0);
    drawMenuSpriteWithAlpha((s16)(arg0->x + 0x50), (s16)(arg0->y + (arg0->item.price * 0x10) + 0x14),
                            getRelocatableHeapBlockBase(gAssetHandles[0x24]), 0x12, 0x20, 0x20, 0, arg0->sprite.index, 0);
}
