...
void func_80049CE0(RaceEffectActor *arg0) {
    ...
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 0, &arg0->image, &arg0->palette);
    func_800499A4(arg0);
...
void func_8004A648(RaceEffectActor *arg0) {
    ...
    arg0->pos.z += D_80121D80[arg0->playerIndex].velocity.z;
    arg0->startAngle = D_80121D80[arg0->playerIndex].surfaceAngle;
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 2, &arg0->image, &arg0->palette);
    func_8004A2F4(arg0);
...
void func_8004AFE4(RaceEffectActor *arg0) {
    ...
    arg0->pos.z += D_80121D80[arg0->playerIndex].velocity.z;
    arg0->startAngle = D_80121D80[arg0->playerIndex].surfaceAngle;
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 3, &arg0->image, &arg0->palette);
    func_8004AC5C(arg0);
...
void func_8004BFA0(RaceEffectActor *arg0) {
    ...
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 4, &actor->image, &actor->palette);
    func_8004BC74(actor);
...
void func_8004C8F0(RaceEffectActor *arg0) {
    ...
    actor->pos.z += D_80121D80[actor->playerIndex].posA8.z;
    actor->startAngle = D_80121D80[actor->playerIndex].surfaceAngle;
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 1, &actor->image, &actor->palette);
    func_8004C5B4(actor);
...
void func_8004D184(RaceEffectActor *arg0) {
    ...
    func_80045990(getRelocatableHeapBlockBase(D_80112168), 2, &arg0->image, &arg0->palette);
    func_8004D018(arg0);
...
void func_8004D880(RaceEffectActor *arg0) {
    ...
    arg0->startAngle = D_80121D80[arg0->playerIndex].surfaceAngle;
    func_80045990(getRelocatableHeapBlockBase(D_8011216C), 5, &arg0->image, &arg0->palette);
    arg0->unk54 = 0;
    func_8004D5C0(arg0);
