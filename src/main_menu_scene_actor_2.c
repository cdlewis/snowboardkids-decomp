...
extern void func_80071824(MainMenuSceneActor2 *arg0, void (*arg1)(MainMenuSceneActor2 *));
...
void func_8003740C(MainMenuSceneActor2 *arg0) {
    ...
    func_800428C8(2);
    if (D_8010B1A2 == 0x41) {
        func_80071824(arg0, func_800373E0);
...
void func_800374DC(MainMenuSceneActor2 *arg0) {
    ...
    if (*p == 0x1E) {
        *p = 0;
        func_80071824(arg0, func_80037484);
        D_8010B1A2 = 0x3F;
    }
}
...
void func_800375A0(MainMenuSceneActor2 *arg0) {
    ...
    if (sp18 == 1) {
        ...
        if (*p == 0x1E) {
            *p = 0;
            func_80071824(arg0, func_80037548);
...
void func_80037620(MainMenuSceneActor2 *arg0) {
    ...
    if (sp18 == 1) {
        ...
        if (*p == 0x14) {
            *p = 0;
            func_80071824(arg0, func_800375A0);
...
void func_80037708(MainMenuSceneActor2 *arg0) {
    ...
    (*p)++;
    if (*p == 0x32) {
        func_80071824(arg0, func_800376AC);
        D_8010B1A2 = 0x3D;
    }
}
...
void func_80037818(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 1) {
        func_80071824(arg0, func_800377C8);
...
void func_80037868(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 1) {
        ...
        if (*p == 0xF) {
            *p = 0;
            func_80071824(arg0, func_80037818);
...
void func_800378E0(MainMenuSceneActor2 *arg0) {
    ...
    if (sp20 == 1) {
        arg0->timer = 0;
        func_80071824(arg0, func_80037868);
...
void func_80037998(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < (s32)0xFFA00001) {
        ...
        func_80071824(arg0, func_800378E0);
        arg0->rotY = 0xC00;
        func_800420FC(2, arg0->rotX, arg0->rotY, arg0->rotZ);
...
void func_80037AA4(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX >= 0x100000) {
        arg0->posX = 0x100000;
        func_80071824(arg0, func_80037A58);
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_800428C8(2);
}
...
void func_80037B6C(MainMenuSceneActor2 *arg0) {
    ...
    if (var_a1 < -0x7FFFFF) {
        ...
        func_80071824(new_var, func_80037B20);
        var_a1 = arg0->posX;
...
void func_80037C28(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A2 == 0x33) {
        ...
        if (*p == 0x14) {
            *p = 0;
            func_80071824(arg0, func_80037B6C);
            arg0->posX = 0x1900000;
            arg0->posZ = 0x120000;
            D_8010B1AA = 0;
...
void func_80037CAC(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < (s32)0xFE700001) {
        ...
        func_80071824(arg0, func_80037C28);
        D_8010B1A2 = 0x31;
        D_8010B1AA = 1;
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
...
void func_80037D48(MainMenuSceneActor2 *arg0) {
    ...
    if (sp20 == 1) {
        arg0->timer = 0;
        func_80071824(arg0, func_80037CAC);
        arg0->posY = 0;
...
void func_80037EA0(MainMenuSceneActor2 *arg0) {
    ...
    func_800428C8(2);
    if (D_8010B1A2 == 0x2D) {
        func_80071824(arg0, func_80037E3C);
    }
}
...
void func_80037F0C(MainMenuSceneActor2 *arg0) {
    ...
    if (*p == 0x19) {
        D_8010B1A2 = 0x2C;
        func_80071824(arg0, func_80037EA0);
        *p = 0;
    }
}
...
void func_80037F74(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 0) {
        ...
        func_80071824(arg0, func_80037F0C);
...
void func_80037FF8(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < (s32)0xFFA80001) {
        ...
        func_80071824(arg0, func_80037F74);
...
void func_800380F0(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX >= 0xF00000) {
        arg0->posX = 0xF00000;
        func_80071824(arg0, func_80038098);
        D_8010B1A2 = 0x29;
        D_8010B1AA = 1;
...
void func_800381E0(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX >= (s32)0xFFD00000) {
        ...
        func_80071824(arg0, func_80038194);
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_800428C8(2);
}
...
void func_8003825C(MainMenuSceneActor2 *arg0) {
    ...
    if (*p == 0xF) {
        *p = 0;
        func_80071824(arg0, func_800381E0);
    }
}
...
void func_800382BC(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < (s32)0xFF800001) {
        ...
        func_80071824(arg0, func_8003825C);
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_800428C8(2);
}
...
void func_80038340(MainMenuSceneActor2 *arg0) {
    ...
    if (*p == 0x19) {
        *p = 0;
        func_80071824(arg0, func_800382BC);
        D_8010B1A2 = 0x27;
    }
}
...
void func_800383AC(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX >= (s32)0xFFD80000) {
        ...
        func_80071824(arg0, func_80038340);
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_800428C8(2);
}
...
void func_80038478(MainMenuSceneActor2 *arg0) {
    ...
    if (var_a1 < (s32)0xFF550001) {
        ...
        func_80071824(arg0, func_80038424);
        D_8010B1A2 = 0x25;
        var_a1 = arg0->posX;
    }
    temp_a2 = &arg0->posY;
...
void func_80038508(MainMenuSceneActor2 *arg0) {
    ...
    if (D_8010B1A2 == 0x24) {
        ...
        if (*p == 0x12) {
            *p = 0;
            func_80071824(arg0, func_80038478);
        }
    }
}
...
void func_8003857C(MainMenuSceneActor2 *arg0) {
    ...
    if (var_a1 >= (s32)0xFFD00000) {
        arg0->posX = 0xFFD00000;
        func_80071824(arg0, func_80038508);
        var_a1 = arg0->posX;
    }
...
void func_80038678(MainMenuSceneActor2 *arg0) {
    ...
    if (var_a1 < (s32)0xFE700001) {
        arg0->posX = 0xFE700000;
        func_80071824(arg0, func_80038628);
        D_8010B1AA = 1;
        var_a1 = arg0->posX;
    }
    temp_a2 = &arg0->posY;
...
void func_80038704(MainMenuSceneActor2 *arg0) {
    ...
    if (var_a1 < (s32)0xFF600001) {
        ...
        func_80071824(arg0, func_80038678);
        func_80041DD4(2, 0x1B);
        arg0->rotY = 0xC00;
        func_800420FC(2, arg0->rotX, arg0->rotY, arg0->rotZ);
        D_8010B1A2 = 0x20;
...
void func_800387D4(MainMenuSceneActor2 *arg0) {
    ...
    if (sp18 == 1) {
        ...
        if (*p == 0x14) {
            *p = 0;
            func_80071824(arg0, func_80038704);
...
void func_800388C0(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 0) {
        ...
        if (*p == 0xF) {
            *p = 0;
            func_80071824(arg0, func_80038854);
...
void func_800389B4(MainMenuSceneActor2 *arg0) {
    ...
    if (sp20 == 1) {
        ...
        if (*p == 5) {
            *p = 0;
            func_80071824(arg0, func_80038954);
            D_8010B1A2 = 0x1D;
        }
    } else {
        arg0->posX += 0xFFFB8000;
...
void func_80038A54(MainMenuSceneActor2 *arg0) {
    ...
    if (sp18 == 1) {
        ...
        if (*p == 0x14) {
            *p = 0;
            func_80071824(arg0, func_800389B4);
...
void func_80038AE8(MainMenuSceneActor2 *arg0) {
    ...
    if (D_8010B1A2 == 0x1C) {
        arg0->timer = 0;
        func_80071824(arg0, func_80038A54);
...
void func_80038B44(MainMenuSceneActor2 *arg0) {
    ...
    if (*p == 0x1E) {
        *p = 0;
        func_80071824(arg0, func_80038AE8);
...
void func_80038BBC(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 1) {
        func_80071824(arg0, func_80038B44);
    } else {
...
void func_80038C2C(MainMenuSceneActor2 *arg0) {
    func_800428C8(2);
    if (D_8010B1A4 == 5) {
        func_80071824(arg0, func_80038BBC);
...
void func_80038C9C(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A4 == 2) {
        ...
        if (func_80041FB4(2) == 1) {
            ...
            (*p)++;
            if (*p == 0x4) {
                func_80071824(arg0, func_80038C2C);
                *p = 0;
            }
        }
    }
...
void func_80038D38(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A4 == 2) {
        ...
        if (func_80041FB4(2) == 1) {
            ...
            (*p)++;
            if (*p == 0x5) {
                func_80071824(arg0, func_80038C9C);
                *p = 0;
            }
        }
    }
...
void func_80038DD4(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A4 == 2) {
        ...
        if (func_80041FB4(2) == 1) {
            ...
            (*p)++;
            if (*p == 0x3) {
                func_80071824(arg0, func_80038D38);
                *p = 0;
            }
        }
    }
...
void func_80038E90(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A4 == 2) {
        if (func_80041FB4(2) == 1) {
            D_8010B1A4++;
            func_80071824(arg0, func_80038DD4);
            func_80041DD4(2, 0x2B);
            arg0->rotY = 0xC01;
            arg0->timer = 0;
        }
...
void func_80038F18(MainMenuSceneActor2 *arg0) {
    ...
    if (D_8010B1A2 == 0x18) {
        func_80071824(arg0, func_80038E90);
...
void func_80038FB4(MainMenuSceneActor2 *arg0) {
    ...
    if (val < 0x2D) {
        ...
        func_80071824(arg0, func_80038F18);
...
void func_8003905C(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < 0x4E0001) {
        arg0->posX = 0x4E0000;
        func_80071824(arg0, func_80038FB4);
...
void func_80039138(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 1) {
        ...
        if (*p == 0xF) {
            *p = 0;
            func_80071824(arg0, func_800390E8);
            func_80041DD4(2, 0x23);
        }
    }
    func_800428C8(2);
...
void func_800391B0(MainMenuSceneActor2 *arg0) {
    if (func_80041FB4(2) == 1) {
        ...
        if (*p == 0xF) {
            *p = 0;
            func_80071824(arg0, func_80039138);
            func_80041DD4(2, 0x22);
        }
    }
    func_800428C8(2);
...
void func_80039228(MainMenuSceneActor2 *arg0) {
    ...
    if (sp20 == 1) {
        arg0->timer = 0;
        func_80071824(arg0, func_800391B0);
        func_80041DD4(2, 0x21);
    }
}
...
void func_800392DC(MainMenuSceneActor2 *arg0) {
    ...
    func_800428C8(2);
    if (D_8010B1A2 == 0x15) {
        func_80071824(arg0, func_80039228);
        arg0->rotY = 0xC00;
        func_800420FC(2, arg0->rotX, arg0->rotY, arg0->rotZ);
        func_80041DD4(2, 0x20);
    }
...
void func_80039354(MainMenuSceneActor2 *arg0) {
    ...
    if (arg0->posX < 0x500001) {
        arg0->posX = 0x500000;
        func_80071824(arg0, func_800392DC);
    }
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_80042034(2);
    func_800428C8(2);
...
void func_800393D4(MainMenuSceneActor2 *arg0) {
    if (D_8010B1A2 == 0x13) {
        func_80071824(arg0, func_80039354);
...
void func_80039440(MainMenuSceneActor2 *arg0) {
    ...
    func_8004209C(2, arg0->posX, arg0->posY, arg0->posZ);
    func_800420FC(2, arg0->rotX, arg0->rotY, arg0->rotZ);
    func_80071824(arg0, func_800393D4);
}
