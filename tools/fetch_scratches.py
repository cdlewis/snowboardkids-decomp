#!/usr/bin/env python3
"""
Fetch all Snowboard Kids scratches from decomp.me API and save as a combined JSON array.
...
BASE_URL = "https://decomp.me/api/scratch?preset=241&page_size=100&has_owner=true&ordering=-last_updated"
