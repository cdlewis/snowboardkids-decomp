...
void drawMenuColoredGlyphScript(volatile s16 x, s16 y, MenuGlyphScript *script, s32 palette, u16 scale, u16 red, u16 blue);
...
void noopMenuSpriteCallback(void);
void drawMenuGlyphScriptWithFontBank(s16 x, s16 y, void *script, s32 palette, s32 scale, s32 arg5);
void drawMenuGlyphScriptDefaultFont(s16 x, s16 y, void *script, s32 palette, s32 scale);
void drawMenuGlyph(s16 x, s16 y, u16 glyph, u8 palette, u16 scale, u16 arg5);
void drawMenuColoredGlyphScript(s32 x, s32 y, void *script, s32 palette, s32 scale, s32 red, s32 blue);
void drawMenuGlyphScript(s32 x, s32 y, u8 *text, s32 palette, s32 scale, s32 colorMode);
void drawMenuColoredGlyph(s16 x, s16 y, u16 glyph, u8 palette, u16 scale, u16 colorMode, s32 fontBank);
void drawMenuAsciiGlyph(s16 x, s16 y, u16 tileX, s32 tileY, u16 palette, u16 scale);
...
s32 drawMenuTilemapSprite(MenuRenderSprite *sprite, s32 arg1, s16 x, s16 y);
void noopMenuSpriteCallback(void);
void drawMenuGlyphScriptWithFontBank(s16 x, s16 y, u16 *script, s32 palette, u16 scale, u16 arg5);
void drawMenuGlyphScriptDefaultFont(s16 x, s16 y, u16 *script, s32 palette, u16 scale);
void drawMenuGlyph(s16 x, s16 y, u16 glyph, u8 palette, u16 scale, u16 arg5);
void drawMenuColoredGlyphScript(s16 x, s16 y, MenuGlyphScript *script, s32 palette, u16 scale, u16 red, u16 blue);
void drawMenuGlyphScript(s32 x, s32 y, u8 *text, s32 palette, s32 scale, s32 colorMode);
void drawMenuColoredGlyph(s16 x, s16 y, u16 glyph, u8 palette, u16 scale, u16 colorMode, s32 fontBank);
void drawMenuAsciiGlyph(s16 x, s16 y, u16 tileX, s32 tileY, u16 palette, u16 scale);
void drawMenuAsciiText(s16 x, s16 y, u8 *text, u16 palette, u16 scale);
