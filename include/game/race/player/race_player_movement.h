...
void pushRacePlayersOutOfCylinderAndApplyItemHit(struct Vec3i *pos, s32 xzSize, s32 ySize, u16 flag);
void pushRacePlayerOutOfCylinderAndApplyItemHit(struct Vec3i *pos, s32 xzSize, s32 ySize, u16 flag, s16 playerIndex);
void pushRacePlayersOutOfCylinderOrApplyItemHit(struct Vec3i *pos, s32 xzSize, s32 ySize, s32 arg3, s16 arg4);
void pushRacePlayerOutOfCylinder(struct Vec3i *pos, s32 xzSize, s32 ySize, s16 playerIndex);
...
void clampRacePlayerVectorXZHalfSpeed(struct Vec3i *vec, struct RacePlayer *player);
