...
#define gDPSetCombineLERP(pkt, a0, b0, c0, d0, Aa0, Ab0, Ac0, Ad0, a1, b1, c1, d1, Aa1, Ab1, Ac1, Ad1)             \
    {                                                                                                              \
        Gfx *_g = (Gfx *)(pkt);                                                                                    \
                                                                                                                   \
        _g->words.w0 =                                                                                             \
            _SHIFTL(G_SETCOMBINE, 24, 8) | _SHIFTL(                                                                \
        ...
        _g->words.w1 =                                                                                             \
            (unsigned int)(GCCc0w1(G_CCMUX_##b0, G_CCMUX_##d0, G_ACMUX_##Ab0, G_ACMUX_##Ad0) | GCCc1w1(            \
                                                                                                   G_CCMUX_##b1,   \
                                                                                                   G_ACMUX_##Aa1,  \
                                                                                                   G_ACMUX_##Ac1,  \
                                                                                                   G_CCMUX_##d1,   \
 ...
 */
#define _gsDPLoadTextureBlockTile(                                                                             \
    timg,                                                                                                      \
    tmem,                                                                                                      \
    rtile,                                                                                                     \
    fmt,                                                                                                       \
...
#define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy)                                      \
    {                                                                                                             \
        ...
        gImmp1(                                                                                                   \
            ...
            G_RDPHALF_1,                                                                                          \
            (_SHIFTL(                                                                                             \
                 ((s) - (((s16)(xl) < 0) ? (((s16)(dsdx) < 0) ? (MAX((((s16)(xl) * (s16)(dsdx)) >> 7), 0))        \
             ...
             _SHIFTL(                                                                                             \
                 ((t) - (((yl) < 0) ? (((s16)(dtdy) < 0) ? (MAX((((s16)(yl) * (s16)(dtdy)) >> 7), 0))             \
