#ifndef MAIN_MENU_SCENE_ACTOR_3_H
#define MAIN_MENU_SCENE_ACTOR_3_H

#include "common.h"

typedef struct MainMenuSceneActor3 MainMenuSceneActor3;
typedef struct MainMenuSceneEffect3 MainMenuSceneEffect3;
